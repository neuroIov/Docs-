...
# 7.**Ecosystem Fund**: 5% unlocked at TGE, then linear vesting over 48 months
# 8.**Treasury**: 10% unlocked at TGE, then linear vesting over 36 months
## **Treasury Management**: 
...
# 9.**Strategic Partnerships**: Case-by-case basis, generally over 24-36 months with project-specific milestones

# 10 **Liquidity Incentives**
- 6% of total supply allocated for liquidity mining programs:

# 11 **Initial DEX Offering (IDO) Liquidity** (30%): Bootstrapping initial trading pairs
