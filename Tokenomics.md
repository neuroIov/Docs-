...
# 7.**Ecosystem Fund**: 
5% unlocked at TGE, then linear vesting over 48 months
# 8.**Treasury**: 
10% unlocked at TGE, then linear vesting over 36 months
## **Treasury Management**: 
...
# 11 **IDO Liquidity** (30%): 
Bootstrapping initial trading pairs
- **Ongoing Liquidity Mining**(70%): 
Distributed over 24 months to incentivize long-term liquidity provision
